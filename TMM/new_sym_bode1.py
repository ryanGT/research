...
def new_sym_bode1(s,ucv):
	...
	a_64 = -ml2*rl2*a_11*a_63-ml2*a_11*a_57-ml1*rl1*a_11*a_26-ml1*a_11 \
		*a_56-ml0*a_11*a_23-ml0*rl0*a_11*a_14-0.5*a_9*a_17*c3beam*a_6+0.5 \
		*betabeam*c2beam*a_4
	...
	a_67 = -Kact*ml2*rl2*s*(-a_28*a_52+Ll2*a_54+ml2*a_27*a_11*a_44-a_50 \
		*a_42-0.5*abeam*a_20*c3beam*a_13+Ll1*a_48+a_33*ml1*a_46*a_11-0.5 \
		*abeam*a_29*c2beam*Lbeam*ml0*a_12*a_11+c1beam*Ll0+0.5*a_3*c4beam \
		*Lbeam)*a_66*tauact*a_2-Kact*a_1*a_28*a_53*a_66*tauact*a_2
