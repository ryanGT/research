 ...
 set size ratio 1;
 set output 'FIGURES\RigidLinkCurveQcv3Q.eps';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 1;
 set output 'FIGURES\RigidLinkCurveQcv2Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'RigidLinkCurve';
 set xlabel 'X1 [m]';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 1;
 set output 'FIGURES\RigidLinkCurveQcv1Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'RigidLinkCurve';
 set xlabel 'X1 [m]';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1QbxcQ.eps';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qi11Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'PropertyBeam1';
 set xlabel 'ETA';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qi23Q.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1QbxkQ.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set title 'PropertyBeam1';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qk11Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'PropertyBeam1';
 set xlabel 'ETA';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qk23Q.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1QbxmQ.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set title 'PropertyBeam1';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qm00Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'PropertyBeam1';
 set xlabel 'ETA';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\PropertyBeam1Qm23Q.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 1;
 set output 'FIGURES\CurveBeam1Qcv3Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 1;
 set output 'FIGURES\CurveBeam1Qcv2Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'CurveBeam1';
 set xlabel 'X1 [m]';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 1;
 set output 'FIGURES\CurveBeam1Qcv1Q.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'CurveBeam1';
 set xlabel 'X1 [m]';
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\CurveBeam1QcrvQ.eps';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 set terminal postscript portrait eps enhanced color "Times New Roman" 18;
 set size ratio 0.75;
 set output 'FIGURES\ScheduleRotationA.eps';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
