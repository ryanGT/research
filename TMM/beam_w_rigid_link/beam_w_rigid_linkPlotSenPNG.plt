 ...
 set output 'FIGURES\SensorBeam1DisplacementsQdisQ.png';
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorBeam1DisplacementsQrotQ.png';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorBeam1PositionsQposQ.png';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorBeam1PositionsQoriQ.png';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set style line  3 lt  3 lw 3.0 pt  3 ps 1.5;
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorEnergyQfseQ.png';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorEnergyQwrkQ.png';
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorEnergyQjseQ.png';
 set key; set border; set grid; set multiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set style line  2 lt  2 lw 3.0 pt  2 ps 1.5;
 set title 'SensorEnergy';
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SensorEnergyQtssQ.png';
 set key; set border; set grid; set nomultiplot;
 set style line  1 lt  1 lw 3.0 pt  1 ps 1.5;
 set title 'SensorEnergy';
 set xlabel 'TIME [sec]';
 ...
 reset
 set terminal png small size 1000, 750;
 set output 'FIGURES\SigPostBeam1Forces.png';
 set key; set border; set grid; set nomultiplot;
