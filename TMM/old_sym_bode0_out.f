...
Cf2py intent(out) bode
     ...
     1   7-ml0*a_1*a_8-ml0*rl0*a_1*a_45-a_42*a_2*c3beam*a_6/2.0+betabeam
     2   *c2beam*a_41/2.0
     ...
     1   ml2*a_10*a_1*a_30-a_36*a_28-abeam*a_3*c3beam*a_25/2.0+Ll1*a_34+
     2   a_16*ml1*a_32*a_1-abeam*a_12*c2beam*Lbeam*ml0*a_23*a_1/2.0+c1be
     3   am*Ll0+a_5*c4beam*Lbeam/2.0)*a_65*tauact*a_66-Kact*a_9*a_11*a_3
     4   9*a_65*tauact*a_66)-abeam*a_12*c2beam*Lbeam*(-Kact*ml2*rl2*s*a_
     5   64*a_65*tauact*a_66-Kact*a_9*a_11*a_63*a_65*tauact*a_66)/2.0)
      RETURN
      END
